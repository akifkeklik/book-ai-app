...
[![Libris CI/CD Status](https://github.com/akifkeklik/book-ai-app/actions/workflows/ci_cd.yml/badge.svg)](https://github.com/akifkeklik/book-ai-app/actions/workflows/ci_cd.yml)
[![Live on Render](https://img.shields.io/badge/Render-Live-success?style=for-the-badge&logo=render)](https://book-ai-app-libris-api.onrender.com/)
...
## 🛡️ Engineering & Operations (CI/CD)

Libris is built with corporate-grade stability. Every commit is automatically verified through our **Engineering Excellence Pipeline**.

### 🤖 Automation Pipeline (GitHub Actions)

- **Backend-CI:** Static analysis via `Ruff` and comprehensive integration tests via `Pytest`.
- **Frontend-CI:** Deep structural analysis and widget testing for the Flutter application.
- **Auto-Deployment:** Successful merges into `main` are automatically shipped to the production environment on **Render.com**.
